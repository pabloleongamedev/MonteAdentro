...
>
> **Delegations Made:**
> - Consulted `game-designer` for XP curve formula validation
> - Consulted `game-designer` for material cost balancing
>
...
> 3. When ready to implement, use `/team-combat` pattern but for crafting (game-designer → gameplay-programmer → unity-specialist → qa-engineer)
>
