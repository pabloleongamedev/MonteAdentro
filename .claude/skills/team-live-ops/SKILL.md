---
name: team-live-ops
description: "Orchestrate the live-ops team for post-launch content planning: coordinates level-designer, game-designer, tools-devops, producer, narrative-writer, and narrative-writer to design and plan a season, event, or live content update."
...
## Team Composition
- **level-designer** — Season structure, event cadence, retention mechanics, battle pass
- **game-designer** — Live economy balance, store rotation, currency pricing, pity timers
- **tools-devops** — Success metrics, A/B test design, event tracking, dashboard specs
- **producer** — Player-facing announcements, event descriptions, seasonal messaging
- **narrative-writer** — Seasonal narrative theme, story arc, world event framing
- **narrative-writer** — Event descriptions, reward item names, seasonal flavor text, announcement copy

## How to Delegate

Use the Task tool to spawn each team member as a subagent:
- `subagent_type: level-designer` — Season/event structure and retention mechanics
- `subagent_type: game-designer` — Live economy balance and reward pricing
- `subagent_type: tools-devops` — Success metrics, A/B tests, event instrumentation
- `subagent_type: producer` — Player-facing communication and messaging
- `subagent_type: narrative-writer` — Seasonal theme and narrative framing
- `subagent_type: narrative-writer` — All player-facing text: event descriptions, item names, copy
...
- **narrative-writer** (if needed): Write any in-game narrative text (cutscene scripts, NPC dialogue, world event descriptions) for the season
- **narrative-writer**: Write all player-facing text — event names, reward item descriptions, challenge objective text, seasonal flavor text
