...
Spawn `tools-devops` via Task. Pass:
...
The tools-devops runs the audit across 6 categories (see Phase 3). Collect their full findings before proceeding.

---

## Phase 3: Audit Categories

The tools-devops evaluates each of the following. Skip categories not applicable to the project scope.
...
**Audited by**: tools-devops via /security-audit
