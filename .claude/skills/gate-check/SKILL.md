...
- [ ] Visual Identity Anchor section exists in `design/gdd/game-concept.md` (from brainstorm Phase 4 art-audio output)
...
**Quality Checks:**
- [ ] Full QA pass signed off by `qa-engineer`
- [ ] All tests passing
...
1. **`game-designer`** — gate **CD-PHASE-GATE** (`.claude/docs/director-gates.md`)
2. **`architect`** — gate **TD-PHASE-GATE** (`.claude/docs/director-gates.md`)
3. **`producer`** — gate **PR-PHASE-GATE** (`.claude/docs/director-gates.md`)
4. **`art-audio`** — gate **AD-PHASE-GATE** (`.claude/docs/director-gates.md`)
...
- **Tests failing?** → delegate to `architect` or `qa-engineer`
