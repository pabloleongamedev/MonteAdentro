...
5.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `architect` via Task using gate **TD-ADR** (`.claude/docs/director-gates.md`):
