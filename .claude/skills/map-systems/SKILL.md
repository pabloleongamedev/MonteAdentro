...
**After dependency mapping is approved, spawn `architect` via Task using gate TD-SYSTEM-BOUNDARY (`.claude/docs/director-gates.md`) before proceeding to priority assignment.**
...
**After the systems index is written, spawn `game-designer` via Task using gate CD-SYSTEMS (`.claude/docs/director-gates.md`).**
