...
**Step 1 — Technical Director self-review** (this skill runs as architect):
...
**Step 2 — Spawn `architect` via Task using gate LP-FEASIBILITY (`.claude/docs/director-gates.md`):**
