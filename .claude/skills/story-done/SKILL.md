...
After completing the deviation checks in Phase 4, spawn `qa-engineer` via Task using gate **QL-TEST-COVERAGE** (`.claude/docs/director-gates.md`).
...
The qa-engineer reviews whether the tests actually cover what was specified — not just whether files exist.
...
Spawn `architect` via Task using gate **LP-CODE-REVIEW** (`.claude/docs/director-gates.md`).
