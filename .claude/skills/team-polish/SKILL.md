---
name: team-polish
description: "Orchestrate the polish team: coordinates qa-engineer, unity-specialist, art-audio, and qa-engineer to optimize, polish, and harden a feature or area for release quality."
...
## Team Composition
- **qa-engineer** — Profiling, optimization, memory analysis, frame budget
- **unity-specialist** — Engine-level bottlenecks: rendering pipeline, memory, resource loading (invoke when qa-engineer identifies low-level root causes)
- **unity-specialist** — VFX polish, shader optimization, visual quality
- **art-audio** — Audio polish, mixing, ambient layers, feedback sounds
- **tools-devops** — Content pipeline tool verification, editor tool stability, automation fixes (invoke when content authoring tools are involved in the polished area)
- **qa-engineer** — Edge case testing, regression testing, soak testing

## How to Delegate

Use the Task tool to spawn each team member as a subagent:
- `subagent_type: qa-engineer` — Profiling, optimization, memory analysis
- `subagent_type: unity-specialist` — Engine-level fixes for rendering, memory, resource loading
- `subagent_type: unity-specialist` — VFX polish, shader optimization, visual quality
- `subagent_type: art-audio` — Audio polish, mixing, ambient layers
- `subagent_type: tools-devops` — Content pipeline and editor tool verification
...
Delegate to **qa-engineer** (with relevant programmers as needed):
