---
name: team-audio
description: "Orchestrate audio team: art-audio + art-audio + unity-specialist + gameplay-programmer for full audio pipeline from direction to implementation."
...
- `subagent_type: art-audio` — Sonic identity, emotional tone, audio palette
- `subagent_type: art-audio` — SFX specifications, audio events, mixing groups
- `subagent_type: unity-specialist` — Audio middleware, bus structure, memory budgets
...
### Step 1: Audio Direction (art-audio)
...
Spawn the `unity-specialist` agent to:
...
- Output: engine audio integration notes to merge with the unity-specialist's plan
...
- Review the audio design doc with the art-audio before implementation begins.
