...
- **If the story already has a `Type:` field in its header**: accept it as-is. Do NOT re-classify or validate against the criteria below — the Type was set by architect at story creation and is authoritative. Record it as-is.
...
**Who must sign off**: [designer / architect / qa-engineer / art-lead]
...
the [designer / qa-engineer] before the story can be marked COMPLETE.
