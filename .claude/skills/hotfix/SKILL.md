...
- `subagent_type: architect` — Review the fix for correctness and side effects
...
After approvals, determine the QA scope required before deploying the hotfix. Spawn `qa-engineer` via Task with:
...
Ask qa-engineer: **Is a full smoke check sufficient, or does this fix require a targeted team-qa pass?**
...
**Approvals**: architect ✓ / qa-engineer ✓ / producer ✓
...
- If the fix is complex enough to need more than 4 hours, escalate to `architect`
