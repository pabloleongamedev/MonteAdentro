...
| Any layer — Type: UI | `unity-specialist` |
...
| Core or Feature — networking, replication | `gameplay-programmer` |
...
|--------|----------------------------|
| Godot 4 | `(n/a in this config — other-engine agent removed)`, `(n/a in this config — other-engine agent removed)`, `(n/a in this config — other-engine agent removed)` |
| Unity | `unity-specialist`, `unity-specialist`, `unity-specialist` |
| Unreal Engine | `(n/a in this config — other-engine agent removed)`, `(n/a in this config — other-engine agent removed)`, `(n/a in this config — other-engine agent removed)`, `(n/a in this config — other-engine agent removed)`, `(n/a in this config — other-engine agent removed)` |
