---
name: team-combat
description: "Orchestrate the combat team: coordinates game-designer, gameplay-programmer, gameplay-programmer, unity-specialist, art-audio, and qa-engineer to design, implement, and validate a combat feature end-to-end."
...
- **unity-specialist** — Create VFX, shader effects, and visual feedback
- **art-audio** — Define audio events, impact sounds, and ambient combat audio
...
- `subagent_type: unity-specialist` — Create VFX, shader effects, visual feedback
- `subagent_type: art-audio` — Define audio events, impact sounds, ambient audio
...
- Options:
  - `[A] Proceed — spawn implementation agents (gameplay-programmer, gameplay-programmer, unity-specialist, art-audio)`
...
- **unity-specialist**: Create VFX and shader effects
- **art-audio**: Define audio event list and mixing notes
