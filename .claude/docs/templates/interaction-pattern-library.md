...
> is needed, add it here (or propose it to the game-designer) before writing the
...
pattern name), determine the impact, get approval from the game-designer, and
...
|----------|-------|----------|-----------|
| [Does the engine's accessibility node system support screen reader announcements for toast notifications without requiring focus? Verify against engine-reference/godot/ for Godot 4.6.] | [game-designer] | [Before first menu implementation] | [Unresolved] |
...
| [Should damage numbers be pooled as Label3D nodes or rendered in a SubViewport? Verify performance budget in coordination with architect.] | [architect, game-designer] | [Before combat HUD implementation] | [Unresolved] |
| [What is the maximum number of simultaneous toast notifications before the queue becomes visually overwhelming? Needs playtesting.] | [game-designer] | [First playtesting session] | [Unresolved] |
