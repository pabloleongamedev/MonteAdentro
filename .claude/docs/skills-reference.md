...
| Command | Coordinates |
|---------|-------------|
| `/team-combat` | game-designer + gameplay-programmer + gameplay-programmer + unity-specialist + art-audio + qa-engineer |
| `/team-narrative` | narrative-writer + narrative-writer + level-designer + level-designer |
| `/team-ui` | game-designer + unity-specialist + art-audio + qa-engineer |
| `/team-release` | producer + qa-engineer + tools-devops + producer |
| `/team-polish` | qa-engineer + unity-specialist + art-audio + qa-engineer |
| `/team-audio` | art-audio + art-audio + unity-specialist + gameplay-programmer |
| `/team-level` | level-designer + narrative-writer + level-designer + art-audio + game-designer + qa-engineer |
| `/team-live-ops` | level-designer + game-designer + producer + tools-devops |
| `/team-qa` | qa-engineer + qa-engineer + gameplay-programmer + producer |
