...
1. For style violations: auto-fix with your formatter or invoke `architect`
2. For hardcoded values: invoke `gameplay-programmer` to externalize the values
3. For test failures: invoke `qa-engineer` to diagnose and `gameplay-programmer` to fix
